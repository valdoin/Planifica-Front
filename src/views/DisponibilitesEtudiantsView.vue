    ...
    <div class="availability-collection-page">
      ...
      <form @submit.prevent="submitAvailability">
        <div class="form-group">
          <input type="email" placeholder="Votre e-mail" required v-model="studentMail">
        </div>
  ...
  export default {
    ...
    methods: {
      ...
      async submitAvailability() {
        try {
          const mail = this.studentMail.trim();
          console.log(mail);
          ...
          if (!student) {
            ...
            window.alert("Vous n'existez malheureusement pas dans notre base de données, veuillez contacter l'administration pour en savoir plus.")
          }
          ...
          const updateResponse = await apiService.updateStudent(studentId, { availabilities });
